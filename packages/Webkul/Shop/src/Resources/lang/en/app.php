...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2020 - :current_year, Introps IT',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2020 - :current_year, Introps IT',
                'locale'                 => 'Locale',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'mini-cart' => [
                ...
                'excl-tax'             => 'Excl. Tax:',
                //'offer-on-orders'      => 'Get Up To 30% OFF on your 1st order bokkaa',
                'remove'               => 'Remove',
                'see-details'          => 'See Details',
